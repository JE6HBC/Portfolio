...
const translations = {
    ja: {
        ...
        'implementation-title': '圧倒的な現場実装力',
        ...
        'fendi-title': 'FENDI SPY スペシャルムービー',
        'fendi-desc': '目黒蓮氏出演のスペシャルムービーにて1st ACを担当。シネマトグラファー領域へ本格進出。',
    ...
    en: {
        ...
        'implementation-title': 'Overwhelming Field Implementation',
        ...
        'fendi-title': 'FENDI SPY Special Movie',
        'fendi-desc': 'Served as 1st AC for special movie featuring Ren Meguro. Full-scale entry into cinematographer domain.',
        ...
        '無線技術 (1アマ/2陸技)': 'Radio Technology (1st Amateur/2nd Land)',
        'Software Development': 'Software Development',
